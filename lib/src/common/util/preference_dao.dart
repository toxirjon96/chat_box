...
abstract base class PreferencesDao {
  ...
  PreferencesEntry<int> intEntry(String key) => _PreferencesEntry(
        sharedPreferences: _sharedPreferences,
        key: key,
      );

  PreferencesEntry<double> doubleEntry(String key) => _PreferencesEntry(
        sharedPreferences: _sharedPreferences,
        key: key,
      );

  PreferencesEntry<bool> boolEntry(String key) => _PreferencesEntry(
        sharedPreferences: _sharedPreferences,
        key: key,
      );

  PreferencesEntry<String> stringEntry(String key) => _PreferencesEntry(
        sharedPreferences: _sharedPreferences,
        key: key,
      );

  PreferencesEntry<Iterable<String>> iterableEntry(String key) =>
      _PreferencesEntry(
        sharedPreferences: _sharedPreferences,
        key: key,
      );
